            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-2xl p-3 border border-white/10">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="text-3xs text-emerald-200/80">4 tiêu chí: Phát âm, Trọng âm, Lưu loát & Độ chuẩn xác</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-2xl p-3 border border-white/10">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="text-3xs text-emerald-200/80">Tích lũy XP, đua bảng xếp hạng và duy trì phản xạ mỗi ngày</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-2xl p-3 border border-white/10">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="text-3xs text-emerald-200/80">Phỏng vấn xin việc, họp dự án, giao tiếp hàng ngày N5-N3</p>
                </div>
              </div>
            </div>
          </div>
