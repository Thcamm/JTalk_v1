  ...
  return (
    ...
    >
      ...
      {(feedback?.generalAdvice || (feedback?.grammarSuggestions && feedback.grammarSuggestions.length > 0)) && (
        <div className="p-4 bg-emerald-50/70 dark:bg-emerald-950/60 border border-emerald-200/80 dark:border-emerald-800 rounded-2xl space-y-2">
          ...
          {feedback.grammarSuggestions && feedback.grammarSuggestions.length > 0 && (
            <div className="space-y-1 pt-1">
              <span className="text-xs font-semibold text-emerald-900 dark:text-emerald-200">Mẫu câu nói tự nhiên hơn:</span>
              <ul className="list-disc list-inside text-xs text-emerald-800 dark:text-emerald-300 space-y-0.5 pl-1">
